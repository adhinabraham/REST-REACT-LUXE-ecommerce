...
function Header() {
 const navigate = useNavigate()
  ...
  const logedusername = localStorage.getItem("name");

  const usernamefun = () => {
   const data={"id":saved}
    axios.post("http://127.0.0.1:8000/user/name",data).then((Response) => {
      console.log(Response.data, "loginnnnnnnnnnnnnn funciton");
            ...
            <div className="flex items-center justify-between border-b border-gray-200 dark:border-gray-700 py-4">
              ...
              <div className="hidden md:block">
                <ul className="flex items-center space-x-6">
                  <li>
                    <button
                      className="dark:text-white border-none dark:hover:text-gray-300 text-base text-right text-gray-800 focus:outline-none  hover:underline"
                      onClick={() => {
                        navigate("/");
                      }}
                    >
                  ...
                  {/* <li>
                          <button  className="dark:text-white border-none dark:hover:text-gray-300 text-base text-right text-gray-800 focus:outline-none  hover:underline">
                              {" "}
                              Kids{" "}
                          </button>
                      </li>
