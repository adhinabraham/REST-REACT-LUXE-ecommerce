...
function Carosal() {
 ...
 useEffect(() => {
   axios
     .get("http://127.0.0.1:8000/product/productlist/")
     .then((Response) => {
          ...
          >
            <div className="w-full relative flex items-center justify-center">
              ...
              <ButtonNext
                role="button"
                aria-label="slide forward"
                className="absolute z-30 right-0 mr-8 focus:outline-none focus:bg-black focus:ring-2 focus:ring-offset-2 focus:ring-gray-400"
                id="next"
              >
                <svg
                  width={8}
